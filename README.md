...
https://github.com/Chixpy/ETKRes-32X/archive/main.zip
...
All images in .png format at original resolution: Same as MegaDrive / Genesis: **320×224**, **256×224** (NTSC); **320×240**, **256×240** (PAL).

Some games change resolution on the fly. Title can be in 320×224 while game play is at 256×224.
